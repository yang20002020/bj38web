...
import (
	"bj38web_082/web/model"
	"bj38web_082/web/proto/getCaptcha"
	userMico "bj38web_082/web/proto/user"
	"bj38web_082/web/utils"
	"context"
	"encoding/json"
	"fmt"
...
func GetSession(ctx *gin.Context) {
	...
	if userName == nil {
		...
		/*{"data":{"name":"158******"},"errmsg":"成功","errno":"0"}*/
		var nameData struct {
...
func GetSmscd(ctx *gin.Context) {
	...
	//http://192.168.***.***:8080/api/v1.0/smscode/15*******?text=enhe&id=56b89c6b-d62d-45c2-b84d-e9d80d8f187c
...
func GetUserInfo(ctx *gin.Context) {
	...
	//resp["errno"] = utils.RECODE_OK
	//resp["errmsg"] = utils.RecodeText(utils.RECODE_OK)
	//{"data":{"avatar_url":"http://192.168.***.***:8080/group1/M00/00/00/wKg_gGOAZq6Abq7mAADe1y314UQ299.png",
	//         "id_card":"13120151224",
	//         "mobile":"158****",
	//         "name":"158*****",
	//         "real_name":"yangzhang",
	...
	//temp["avatar_url"] = "http://192.168.****.****:8080/" + user.Avatar_url
	//
	//resp["data"] = temp
	/********************************************/
	/*********微服务功能***************/
...
func PostAvatar(ctx *gin.Context) {
	...
	temp := make(map[string]interface{})
	temp["avatar_url"] = "http://192.168.***.***:8080/" + remoteId
	resp["data"] = temp
