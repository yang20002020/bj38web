...
import (
	"bj38web_078/web/model"
	"bj38web_078/web/proto/getCaptcha"
	userMico "bj38web_078/web/proto/user"
	"bj38web_078/web/utils"
	"context"
	"encoding/json"
	"fmt"
...
func GetSmscd(ctx *gin.Context) {
	...
	//http://192.***.****.***:8080/api/v1.0/smscode/15**********?text=enhe&id=56b89c6b-d62d-45c2-b84d-e9d80d8f187c
...
func GetUserInfo(ctx *gin.Context) {
	...
	resp["errno"] = utils.RECODE_OK
	resp["errmsg"] = utils.RecodeText(utils.RECODE_OK)
	//{"data":{"avatar_url":"","id_card":"","mobile":"15******","name":"15*******",
