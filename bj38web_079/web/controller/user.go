...
import (
	"bj38web_079/web/model"
	"bj38web_079/web/proto/getCaptcha"
	userMico "bj38web_079/web/proto/user"
	"bj38web_079/web/utils"
	"context"
	"encoding/json"
	"fmt"
...
func GetSession(ctx *gin.Context) {
	...
	if userName == nil {
		...
		/*{"data":{"name":"15***********"},"errmsg":"成功","errno":"0"}*/
		var nameData struct {
...
// 发送注册信息
/*{mobile: "15*****", password: "111", sms_code: "94851"}
mobile: "15******"
password: "111"
sms_code: "94851" */
...
func GetUserInfo(ctx *gin.Context) {
	...
	resp["errno"] = utils.RECODE_OK
	resp["errmsg"] = utils.RecodeText(utils.RECODE_OK)
	//{"data":{"avatar_url":"","id_card":"","mobile":"158*******","name":"15******",
