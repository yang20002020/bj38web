...
import (
	"bj38web_083/web/model"
	"bj38web_083/web/proto/getCaptcha"
	userMico "bj38web_083/web/proto/user"
	"bj38web_083/web/utils"
	"context"
	"encoding/json"
	"fmt"
...
func GetSmscd(ctx *gin.Context) {
	...
	//http://192.168.***.****:8080/api/v1.0/smscode/158*****?text=enhe&id=56b89c6b-d62d-45c2-b84d-e9d80d8f187c
...
func _main(args []*string, phone string, resp map[string]string) (_err error) {
	...
	sendSmsRequest := &dysmsapi20170525.SendSmsRequest{
		...
		PhoneNumbers:  tea.String(phone), //1***********
